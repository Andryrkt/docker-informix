...
import { Building2, Briefcase, LayoutTemplate, Menu, Settings, Users, Layers, ShieldCheck, X, MousePointerClick, ClipboardList, MapPin, Contact } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/personnel",    label: "Personnel",   icon: Contact      },
