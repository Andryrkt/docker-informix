        ...
        <tbody className="bg-white divide-y divide-gray-100">
          {devis.map((d, i) => (
            ...
            >
              ...
              <td
                className="px-4 py-3 text-gray-600 max-w-[160px] truncate"
                title={d.REFERENCE_CLIENT}
              >
                {d.REFERENCE_CLIENT || "—"}
              </td>
              ...
              <td className="px-4 py-3 whitespace-nowrap">
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statutColor(d.STATUT_DW)}`}
                >
                  {d.STATUT_DW || "—"}
                </span>
              </td>
              <td className="px-4 py-3 whitespace-nowrap">
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statutColor(d.STATUT_BC)}`}
                >
                  {d.STATUT_BC || "—"}
                </span>
              </td>
